...
export const DiagnosticCodes = {
    ...
    InvalidAchievementHiddenPreEarnedDesc:
        "invalid-hidden-pre-earned-description",
...
const DiagnosticMetadata: Record<DiagnosticCode, DiagnosticMetadata> = {
    ...
    [DiagnosticCodes.CapitalLettersWillBeLowercased]: {
        message:
            "The capital letters in this slot's name will be turned into lowercase values.",
        severity: DiagnosticSeverity.Warning,
    },
    ...
    [DiagnosticCodes.MissingAchievementPreEarnedDesc]: {
        message:
            "Comand *achievement is missing its indented pre-earned description.",
    },
    ...
    [DiagnosticCodes.MissingParentheses]: {
        message:
            "Arguments to an *if or *selectable_if before an #option must be in parentheses.",
        severity: DiagnosticSeverity.Warning,
    },
    ...
    [DiagnosticCodes.SceneNotFound]: {
        message:
            "This scene wasn't found in startup.txt or in the game's folder.",
        severity: DiagnosticSeverity.Warning,
    },
    ...
    [DiagnosticCodes.TextAfterReuse]: {
        message:
            "Nothing except an *if or *selectable_if is allowed between a reuse command and the #option.",
    },
    ...
    [DiagnosticCodes.UnallowedCommandBeforeOption]: {
        message:
            "Only *if, *selectable_if, or one of the reuse commands allowed in front of an option",
    },
