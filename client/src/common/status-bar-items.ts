...
export class StatusBarItems {
    ...
    constructor() {
        this._runningTestItem = vscode.window.createStatusBarItem(
            "cs_running_tests",
        ...
        this._runGameStatusBarItem = vscode.window.createStatusBarItem(
            "cs_run_game",
            vscode.StatusBarAlignment.Left,
            10,
        );
        ...
        this._wordCountStatusBarItem = vscode.window.createStatusBarItem(
            "cs_word_count",
    ...
    public updateSelectionCount(
        selectionCount: number | undefined = undefined,
    ): void {
