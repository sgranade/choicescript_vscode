...
export async function activate(context: ExtensionContext) {
    ...
    const debugOptions = {
        execArgv: [
            "--nolazy",
            process.env["DEBUG_WAIT_FOR_SERVER"]
    ...
    const clientConstructor: LanguageClientConstructor = (
        id: string,
        name: string,
    ...
    console.log(
        "Activating a ChoiceScript Language client in a node extension host context",
    );
