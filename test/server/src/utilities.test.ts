...
describe("Utilities", () => {
    describe("Case-Insensitive Map", () => {
        ...
        it("should create case-sensitive maps", () => {
            const origMap = new CaseInsensitiveMap([
                ["vaR", 1],
                ["oTheR", 2],
            ]);
            ...
            expect(Array.from(origMap.entries())).to.eql([
                ["var", 1],
                ["other", 2],
            ]);
            expect(Array.from(newMap.entries())).to.eql([
                ["vaR", 1],
                ["oTheR", 2],
            ]);
        });
        ...
        describe("Reading Next Lines", () => {
            ...
            it("should capture leading whitespace", () => {
                ...
                expect(line).to.eql({
                    line: "  line2",
                    index: 6,
                    splitLine: { padding: "  ", contents: "line2" },
                });
            });
            ...
            it("should capture leading whitespace and a trailing carriage return", () => {
                ...
                expect(line).to.eql({
                    line: "  line1\n",
                    index: 0,
                    splitLine: { padding: "  ", contents: "line1" },
                });
            });
        });
